...
## Project Structure
    ...
    ├── testapiautosetting_125892  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125892`
...
2. Clone this repo and `cd testapiautosetting_125892`
